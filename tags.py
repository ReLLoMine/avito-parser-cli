...
class AvitoCSSTags:
    ...
    PROMOTED = (By.CSS_SELECTOR, "[class*='styles-redesign']")
    PUBLISH_DATE = (By.CSS_SELECTOR, "[data-marker='item-view/item-date']")
    ...
    ADDRESS = (By.CSS_SELECTOR, "[class*='style-item-address']")
    IMG = (By.CSS_SELECTOR, "[class*='photo-slider-image']")
